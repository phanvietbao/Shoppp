					...
					<div class="s_product_text">
						...
						<form action="OrderServlet" method="POST">
							<input hidden="true" type="number" name="productId"
								value="${product.id}">
							<input hidden="true"  name="productName"
								value="${product.name}"> 
							<input hidden="true" name="quantity"
								value=1> 
							<input hidden="true"  name="image"
								value="${product.image}"> 
								<input hidden="true"  name="price"
								value="${product.price}">
							<input hidden="true"
							...
							<input
								...
								<input
								hidden="true" name="image" value="${product.image}"> 
								<input
								hidden="true" name="quantity" value="${product.quantity}"> 
							<input
							...
							<div class="product_count">
								...
								<input type="text" name="qantt" id="sst" size="2" maxlength="12"
