			...
			<div class="row">
				...
				<div class="col-lg-6">
					<div class="login_form_inner register_form_inner">
						...
						<form class="row login_form" action="SignUpServlet" method="POST" id="register_form" >
              ...
              <div class="col-md-12 form-group">
							...
							<div class="col-md-12 form-group">
								<input type="text" class="form-control" id="name" name="address" placeholder="Adderss" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Address'">
							</div>
							<div class="col-md-12 form-group">
